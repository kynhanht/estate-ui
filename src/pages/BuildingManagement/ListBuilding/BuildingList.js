...
const tableHeaders = [
    { label: 'ID', key: 'id' },
    { label: 'Tên ảnh', key: 'imageName' },
    { label: 'Tên tòa nhà', key: 'buildingName' },
    { label: 'Số tầng hầm', key: 'numberOfBasement' },
    { label: 'Địa chỉ', key: 'address' },
    { label: 'Tên người quản lý', key: 'managerName' },
    { label: 'Số điện thoại người quản lý', key: 'managerPhone' },
    { label: 'Giá thuê', key: 'rentPrice' },
...
class BuildingList extends Component {
    ...
    render() {
        ...
        const { buildings, pagination, roleCode } = this.props;
